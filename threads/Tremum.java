package threads;
import static tela.Tela.trem;
import static tela.Tela.tremdois;
import static tela.Tela.greenflag2;
import static tela.Tela.redflag2;
import static tela.Tela.greenflag4;
import static tela.Tela.redflag4;
/*=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
...
Nome.....: Tremum.java
Funcao...: Classe Tremum, onde as funcoes da thread do primeiro tren sao configuradas (Movimentacao, acesso, etc.).
=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=*/
